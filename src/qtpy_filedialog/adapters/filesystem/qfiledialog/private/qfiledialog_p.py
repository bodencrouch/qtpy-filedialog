...
class QFileDialogPrivate:
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        )  # TODO(bodencrouch): native dialog, disable for now.  # noqa: FBT003
    ...
    def init(self, q: QFileDialog) -> None:
        ...
        ):  # FIXME(bodencrouch): incorrect check, look at docs later.
    ...
    def initHelper(self, h: QPlatformFileDialogHelper) -> None:
        ...
        # h.setOptions(self.options)  # TODO(bodencrouch): implement the platform helpers.
    ...
    def canBeNativeDialog(self) -> bool:
        ...
        """
        return False  # TODO(bodencrouch): Implement this
